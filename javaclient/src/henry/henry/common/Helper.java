...
public class Helper {
    ...
    public static void saveFacturaItem(int num, Contenido prod, int cantidad, long codigo) 
    		...
    		throws RepositoryException 
    {
    	...
    	if (!c.hasNext()) {
    		throw new FetchException("cannot fetch Contenido with " + prodId + " and " + bodegaId);
    	}
    	return c.next();
    }
